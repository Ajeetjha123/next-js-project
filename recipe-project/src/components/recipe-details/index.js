...
export default function RecipeDetailsItem({ getRecipeDetails }) {
  return (
    <div>
      <Link href={"/recipe"}>Go To Recipe List</Link>
      <div className="p-6 lg:max-w-6xl max-w-2xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          <div className="w-full lg:sticky top-0 flex gap-2">
            <img
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4 mt-5">
              <p className="text-2xl text-gray-650">
            ...
            <div className="mt-5">
              ...
              <ul className="space-y-3 list-disc mt-4 pl-4 text-sm text-gray-700">
                {getRecipeDetails?.ingredients.map((item) => (
                  <li key={getRecipeDetails.id}>{item}</li>
                ))}
              </ul>
            </div>
          </div>
